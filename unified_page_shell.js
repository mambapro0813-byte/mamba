/* AI TRADE unified page shell — keep one UI while reusing legacy functional pages */
(()=>{
...
const map={
 ...
 tasks:['follow','任务中心','Tasks / Follow-up'],
 calendar:['follow','日程日历','Calendar / Follow-up Plan'],
